...
static constexpr char default_psv_themes_url[] = "http://pkgj.oss-accelerate.aliyuncs.com/tsv/titles_psvthemes.tsv";
static constexpr char default_psx_games_url[] = "http://pkgj.oss-accelerate.aliyuncs.com/tsv/titles_psxgames.tsv";
