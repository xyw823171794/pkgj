...
#define PKGI_COLOR_DIALOG_BACKGROUND PKGI_COLOR(0x60, 0x5c, 0xa8)
#define PKGI_COLOR_GAMEVIEW_BACKGROUND PKGI_COLOR(0, 0x1f, 0x3f)
...
#define PKGI_COLOR_TEXT_WARN PKGI_COLOR(255, 255, 50)
#define PKGI_COLOR_TEXT_ERROR PKGI_COLOR(255, 50, 50)
#define PKGI_COLOR_TEXT_HOVER PKGI_COLOR(0x72, 0xAF, 0xD2)
...
#define PKGI_GAMEVIEW_HMARGIN 50
#define PKGI_GAMEVIEW_VMARGIN 50
#define PKGI_GAMEVIEW_PADDING 10
#define PKGI_GAMEVIEW_WIDTH (VITA_WIDTH - 2 * PKGI_GAMEVIEW_HMARGIN)
#define PKGI_GAMEVIEW_HEIGHT (VITA_HEIGHT - 2 * PKGI_GAMEVIEW_VMARGIN)

#define PKGI_GAMEVIEW_PROCESS_BAR_HEIGHT 10
#define PKGI_GAMEVIEW_PROCESS_BAR_PADDING 10
#define PKGI_GAMEVIEW_PROCESS_BAR_CHUNK 200
